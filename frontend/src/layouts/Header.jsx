        ...
        <div className="me-auto pc-mob-drp">
          <Nav className="list-unstyled">
            ...
            <Nav.Item className="pc-h-item pc-sidebar-popup">
              <Nav.Link as={Link} to="#" className="pc-head-link ms-0" id="mobile-collapse" onClick={() => handlerDrawerOpen(!sidebarOpen)}>
                <i className="ph ph-list" />
              </Nav.Link>
            </Nav.Item>
          ...
          <Nav className="list-unstyled">
            <Dropdown className="pc-h-item" align="end">
              <Dropdown.Toggle className="pc-head-link me-0 arrow-none" variant="link" id="notification-dropdown">
                ...
                <span className="badge bg-success pc-h-badge">0</span>
              </Dropdown.Toggle>
